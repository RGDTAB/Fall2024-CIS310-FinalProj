...
class RequestLocationWhenInUse extends UsecaseWithoutParams<PermissionStatus> {
  final PermissionsRepository _repository;

  RequestLocationWhenInUse(this._repository);

  @override
  ResultFuture<PermissionStatus> call() async {
    final result = await _repository.requestLocationWhenInUse();
